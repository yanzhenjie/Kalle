...
public class AppConfig {
    ...
    private AppConfig() {
        this.mPreferences = App.get().getSharedPreferences("Kalle", Context.MODE_PRIVATE);

        this.PATH_APP_ROOT = FileUtils.getAppRootPath(App.get()).getAbsolutePath() + File.separator + "Kalle";
